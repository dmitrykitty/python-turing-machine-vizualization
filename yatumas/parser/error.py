...
class ParsingErrorType(Enum):
    ...
    It's accompanying the ParsingError Excetion class.
    """
    ...
    def message(self, index: int) -> str:
        ...
        raise ValueError(f"Unkown value of ParsingErrorType: {self}")


# TODO:
# Create `ParsingError` class.
# 1. It should inherit from the `Exception` class.
# 2. It should match the following docstrings.
"""
...
# TODO continued:
# 3. It should have __init__ matching the docstring:
# tip. initializing message means calling super().__init__ with a correct argument.
"""
    Initializes the parsing error. 
    The error message is initialized using the enum `error_type.message` method.
