...
def _is_empty(line: str) -> bool:
    ...
    --------
    is_empty: bool
        true if and only if the line has length 0 or contains only white cahracter
    """
...
def _is_comment(line: str) -> bool:
    ...
    --------
    is_comment: bool
        true if and only if the line starts with `#` possibly preceeded by white characters
    """
