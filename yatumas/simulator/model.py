...
class Model:
    ...
    machine_input: list[Symbol]
        constains the initial input of the TM
    tape: Tape
        is the currect state of the tape
    machine_state: State
    ...
    # paramaters describing the simulation state
    ...
    # TODO:
    # Create a `current_symbol` property (using @property decorator)
    # - create a getter
    # - and a setter
